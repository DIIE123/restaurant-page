...
const cuisinesArray = [
  {
    ...
    name: "Miso Soup",
    price: 8,
    tags: ["Economical", "Homecooking", "Soup", "Vegetarian"],
  },
  {
    img: riceBall,
    name: "Rice Ball",
    price: 6,
    tags: ["Economical", "Filling", "Homecooking", "Japanese", "Vegetarian"],
  },
  {
    img: grilledLamprey,
    name: "Grilled Lamprey",
    price: 22,
    tags: ["Aquatic", "Grilled", "Signature"],
  },
  {
    img: freshTofu,
    name: "Fresh Tofu",
...
const beveragesArray = [
  ...
  },
  {
    ...
    name: "Sangetsusei",
    price: 34,
    tags: ["Mid Alcohol", "Chillable", "Heatable", "Neat", "Sake"],
  },
  {
    img: sparrowSake,
    name: "Sparrow Sake",
    price: 50,
    tags: ["Mid Alcohol", "Chillable", "Dry", "Heatable", "Sake"],
  },
  {
    img: dassai,
    name: "Dassai",
    price: 130,
    tags: ["Mid Alcohol", "Chillable", "Heatable", "Neat", "Shochu"],
  },
  {
    img: fireRat,
    name: "Fire Rat's Robe",
    price: 420,
    tags: ["High Alcohol", "Dry", "Heatable", "Shochu"],
  },
];
...
export default function createMenu() {
  ...
  cuisinesArray.forEach((item) => cuisines.append(createMenuItem(item)));
  ...
  beveragesArray.forEach((item) => beverages.append(createMenuItem(item)));
